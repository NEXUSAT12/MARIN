...
const { getGroupAdmins, start, info, success, close} = require('./lib/function')
...
case 'ytad': case 'getmusic': case 'yt': case 'youtube': case 'ytmp3': case 'ytmusic': case 'ytdl': {
 ...
 XBotInc.sendMessage(from, {audio: fs.readFileSync(ytmp3play.path),fileName: anu.title + '.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
 }
 break
case 'ytdoc': {
    if (isBan) return reply(mess.banned)	 			
...
❅┈[𝐇𝐚𝐯𝐞 𝐆𝐫𝐞𝐚𝐭 𝐃𝐚𝐲]┈❅
 ...
 🔥 𝐢𝐟 𝐲𝐨𝐮 𝐡𝐚𝐯𝐞 𝐚𝐧𝐲 *𝐛𝐨𝐭 𝐫𝐞𝐥𝐚𝐭𝐞𝐝* 𝐪𝐮𝐞𝐬𝐭𝐢𝐨𝐧 𝐭𝐡𝐞𝐧 𝐚𝐬𝐤 𝐡𝐞𝐫𝐞 *-* https://wa.me/917798203711 .
...
case 'bugcontact':{
		if (isBan) return reply(mess.banned)	 			
		if (isBanChat) return reply(mess.bangc)
	 Nexus.nexusContact(m.chat, global.vk3, m)
	}
break
